        ...
        <asp:DataList ID="MapsDataList" runat="server" RepeatColumns="4" CellPadding="4" OnItemCommand="MapsDataList_ItemCommand" RepeatDirection="Horizontal" OnItemDataBound="MapsDataList_ItemDataBound" CssClass="centered-datalist">
            <ItemTemplate>
                <div class="maps-template">
                    ...
                    <asp:Button ID="EditButton" runat="server" Text="Edit" Height="25px" Width="72px" CssClass="item-button" CommandName="EditButton" BackColor="#c0c0c0"/>
                </div>
            </ItemTemplate>
            <EditItemTemplate>
                <asp:Label ID="MapID" runat="server" Visible="false" Text='<%# Bind("mapID") %>' ></asp:Label>
                <asp:Button ID="FinishButton" runat="server" Text="Finish" Height="25px" Width="72px" CssClass="item-button" CommandName="FinishButton" BackColor="#c0c0c0" Visible="false"/>
                ...
                <asp:Button ID="SubmitButton" runat="server" Text="Submit" Height="25px" Width="72px" CssClass="item-button" CommandName="SubmitButton" BackColor="#c0c0c0" />
            </EditItemTemplate>
        </asp:DataList>
    </div>
</asp:Content>