...
namespace DungeonMaker
{
    public partial class Register : System.Web.UI.Page
    {
        ...
        { //If inputs are valid, completes register
            ...
            if (string.IsNullOrEmpty(UserName_TextBox.Text) || string.IsNullOrEmpty(Gmail_TextBox.Text) || string.IsNullOrEmpty(Password_TextBox.Text)) IsSignUp.Text = "Please fill in all fields.";
