...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="LogIn_Button" class="container" runat="server" OnClick="LogIn_Click" Text="Login" /> <br /> <br />
        <a href="ForgotPassword.aspx"> <asp:Label ID="Forgot_Password_Label" runat="server" Text="Forgot Password"></asp:Label> </a> 
        <asp:LinkButton ID="Guest_Login" runat="server" OnClick="Guest_Login_Click" CssClass="guest-link" Text="Guest Login"></asp:LinkButton> 
        <a href="Register.aspx"> <asp:Label ID="Create_account_label" runat="server" Width="70px">Sign Up</asp:Label> </a>
    </form>
</body>
</html>
