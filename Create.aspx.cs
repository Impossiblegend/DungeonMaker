...
namespace DungeonMaker
{
    public partial class Create : System.Web.UI.Page
    {
        ...
        { //Saves everything and finishes map creation
            ...
            if (string.IsNullOrEmpty(mapName)) { alert("You must name your dungeon."); return; }
            ...
            MapService.DeleteAllButNewestByTrapType("portalFull"); //In case of a duplicates glitch
